...
context('Funcionalidade Login', () => {
    ...
    it('Deve fazer login com sucesso', () => {
        ...
        cy.get('#password').type(userData.userWithValidAccess.password, {log: false})
    ...
    it('Deve exibir mensagem de erro ao inserir usuário inválido', () => {
        ...
        cy.get('#password').type(userData.userWithInvalidEmail.password, {log: false})
        cy.get('.woocommerce-form > .button').click()
    ...
    it('Deve exibir mensagem de erro ao inserir senha inválida', () => {
        ...
        cy.get('#password').type(userData.userWithInvalidPassword.password, {log: false})
        cy.get('.woocommerce-form > .button').click()
